/**
 * TC -> O(4^(m*n)) -> 4 directions -> loose bound
 * TC -> O(3^(m*n)) -> 3 directions -> as we can't go back to the parent-> tighter bound
 * TC -> O(2^(2m+2n-4) 3^(mn - (2m+2n-4))) -> as from the boundary cells, we can only make 2 calls, and number of boundary cells are 2m+2n-4
 */
